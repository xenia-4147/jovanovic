...
const ViewCardPage = () => {
  ...
  const isOwner = user && card.is_owner;

  return (
    <div className="min-h-screen" style={{ backgroundColor: `${card.background_color || card.backgroundColor}10` }}>
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        {/* Show compact view for external viewers, detailed view for owners */}
        {!isOwner ? (
          <CompactBusinessCard 
            card={card}
            onCall={handleCall}
          ...
          /* Original detailed view for owners */
          <Card 
